...
class AdroitRunner(BaseRunner):
    ...
    def run(self, policy: BasePolicy):
        ...
        for episode_idx in tqdm.tqdm(range(self.eval_episodes), desc=f"Eval in Adroit {self.task_name} RGBD Env",
            ...
            while not done:
                ...
                with torch.no_grad():
                    ...
                    obs_dict_input['depth'] = obs_dict['depth'].unsqueeze(1).unsqueeze(0)
